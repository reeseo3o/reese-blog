...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.529412, 0.807843, 0.980392); // 하늘색 (87CEF7)
    const vec3 baseColor2 = vec3(0.670588, 0.458824, 0.988235); // 보라색 (AB75FC)
    const vec3 baseColor3 = vec3(0.196078, 0.509804, 0.929412); // 파랑색 (3282ED);
